...
#core params...
flags.DEFINE_string('model', '', 'model names. See README for possible values.')  
...
flags.DEFINE_string('path', '', 'name of the object file that stores the training data. must be specified.')
...
def train(train_data, test_data=None):
    ...
    print("Optimization Finished! Hey")
